const runningDate = new Date('2024-05-05T08:00:00');
        ...
        $('.run-5k').on('click', function () {
            mudarImagem('https://cdn.ticketagora.com.br/ticketagora/site/Nike-2024-SP/mapa-nike-5k.svg');
        ...
        $('.run-10k').on('click', function () {
            mudarImagem('https://cdn.ticketagora.com.br/ticketagora/site/Nike-2024-SP/mapa-nike-10k.png');
        ...
        $('.run-15k').on('click', function () {
            mudarImagem('https://cdn.ticketagora.com.br/ticketagora/site/Nike-2024-SP/mapa-nike-15k.jpg');
        ...
        $('.run-21k').on('click', function () {
            mudarImagem('https://cdn.ticketagora.com.br/ticketagora/site/Nike-2024-SP/mapa-nike-21k.png');
